    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, max_length=30, null=True, verbose_name='所在地')),
                ...
                ('github', models.CharField(blank=True, max_length=39, null=True, verbose_name='GitHub用户名')),
                ('twitter', models.CharField(blank=True, max_length=15, null=True, verbose_name='Twitter用户名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog_theme', models.CharField(choices=[('light', '简洁亮色'), ('dark', '暗黑模式'), ('card', '卡片风格')], default='light', max_length=20)),
                ('blog_background', models.ImageField(blank=True, null=True, upload_to='blog_backgrounds/')),
